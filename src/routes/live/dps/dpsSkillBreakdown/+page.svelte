<script lang="ts">
  ...
  let dpsSkillBreakdownWindow: DPSSkillBreakdownWindow = $state({ currPlayer: { uid: 0n, name: "", class: "", classSpec: "", abilityScore: 0, totalDmg: 0n, dps: 0, dmgPct: 0, critRate: 0, critDmgRate: 0, luckyRate: 0, luckyDmgRate: 0, hits: 0n, hitsPerMinute: 0 }, skillRows: [], totalDmg: 0n });
