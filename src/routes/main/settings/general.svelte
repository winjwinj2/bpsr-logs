...
<Tabs.Content value={SETTINGS_CATEGORY}>
  ...
  <SettingsSwitch bind:checked={SETTINGS.general.state.alternateNameDisplay} label="Alternate Name Display" description="Alternate name Display -> Name (Ability Score)" />
