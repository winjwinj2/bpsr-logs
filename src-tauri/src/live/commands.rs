        ...
        if is_player && did_damage {
            ...
            for (&skill_uid, skill) in &entity.skill_uid_to_skill {
                let skill_row = SkillRow {
                    ...
                    dps: (skill.total_dmg as f64) / time_elapsed_secs.max(f64::MIN_POSITIVE) * 100.0,
                    hits: skill.hits,
                    hits_per_second: skill.hits as f64 / time_elapsed_secs.max(f64::MIN_POSITIVE) * 100.0,
            ...
            damage_row.dps = total_dmg as f64 / time_elapsed_secs.max(f64::MIN_POSITIVE);
            ...
            damage_row.hits_per_second = total_hits as f64 / time_elapsed_secs.max(f64::MIN_POSITIVE);
